...
public class formMain extends javax.swing.JFrame {
  ...
  private void prepareIcon() {
    // FontIcon icon = FontIcon.of(IkonResolver);
  }
  ...
  private void initComponents() {
    ...
    mngPaneLabel.setFont(new java.awt.Font("Google Sans", 1, 18)); // NOI18N
    mngPaneLabel.setForeground(new java.awt.Color(50, 49, 48));
    mngPaneLabel.setText("Add new book");

    idField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    idField.setForeground(new java.awt.Color(50, 49, 48));
    idField.setEnabled(false);

    idFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    idFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    idFieldLabel.setText("Id");

    nameFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    authorFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    authorFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    authorFieldLabel.setText("Author");

    authorField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    authorField.setForeground(new java.awt.Color(50, 49, 48));

    categoryFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    categoryFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    categoryFieldLabel.setText("Category");

    categoryField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    categoryField.setForeground(new java.awt.Color(50, 49, 48));

    publisherFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    publisherFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    publisherFieldLabel.setText("Publisher");

    publisherField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    publishedFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    publishedFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    publishedFieldLabel.setText("Published year");

    publishedField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    publishedField.setForeground(new java.awt.Color(50, 49, 48));

    quantityFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    quantityFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    quantityFieldLabel.setText("Quantity");

    quantityField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    quantityField.setForeground(new java.awt.Color(50, 49, 48));

    priceFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    priceFieldLabel.setForeground(new java.awt.Color(50, 49, 48));
    priceFieldLabel.setText("Price");

    priceField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    priceField.setForeground(new java.awt.Color(50, 49, 48));

    rentField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    rentField.setForeground(new java.awt.Color(50, 49, 48));

    rentFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    addBtn.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    clearBtn.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    filterPanelLabel.setFont(new java.awt.Font("Google Sans", 1, 18)); // NOI18N
    filterPanelLabel.setText("Filter");

    filterNameFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    filterNameFieldLabel.setText("Name");

    filterNameField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    filterAuthorField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    filterAuthorFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    filterAuthorFieldLabel.setText("Author");

    filterCategoryField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    filterCategoryFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    filterCategoryFieldLabel.setText("Category");

    filterPublisherField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    filterPublisherFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    filterPublisherFieldLabel.setText("Publisher");

    filterYearField.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
    ...
    filterYearFieldLabel.setFont(new java.awt.Font("Google Sans", 0, 14)); // NOI18N
  ...
  private void fillBookForm(Long bookId) {
    ...
    this.book = book;
    this.bookId = bookId;
    mngPaneLabel.setText("Edit " + book.getName().toUpperCase());
  ...
  private void addBook() {
    ...
    int publishedYear = Integer.parseInt(publishedField.getText());
    int quantity = Integer.parseInt(quantityField.getText());
    float price = Float.parseFloat(priceField.getText());
    float rent = Float.parseFloat(rentField.getText());

    Book newBook = new Book(id, name, author, category, publisher, publishedYear, quantity, price, rent);
